...
INSERT INTO migrations VALUES(351,'0001_01_01_000000_create_users_table',2);
INSERT INTO migrations VALUES(352,'0001_01_01_000001_create_cache_table',2);
INSERT INTO migrations VALUES(353,'0001_01_01_000002_create_jobs_table',2);
INSERT INTO migrations VALUES(354,'2025_06_02_012027_create_machines_table',2);
INSERT INTO migrations VALUES(355,'2025_06_02_012059_create_processes_table',2);
INSERT INTO migrations VALUES(356,'2025_06_02_012060_create_operations_table',2);
INSERT INTO migrations VALUES(357,'2025_06_02_012060_create_products_table',2);
INSERT INTO migrations VALUES(358,'2025_06_02_012060_create_shifts_table',2);
INSERT INTO migrations VALUES(359,'2025_06_02_152333_create_product_components_table',2);
INSERT INTO migrations VALUES(360,'2025_06_02_163054_create_cos_table',2);
INSERT INTO migrations VALUES(361,'2025_06_02_163055_create_co_products_table',2);
INSERT INTO migrations VALUES(362,'2025_06_02_172421_create_schedules_table',2);
INSERT INTO migrations VALUES(363,'2025_06_21_071126_create_plans_table',2);
INSERT INTO migrations VALUES(364,'2025_06_21_071637_create_simulate_schedules_table',2);
INSERT INTO migrations VALUES(365,'2025_06_21_194138_create_plan_product_cos_table',2);
INSERT INTO migrations VALUES(366,'2025_07_22_182605_create_personal_access_tokens_table',2);
INSERT INTO migrations VALUES(367,'2025_08_06_145540_create_components_table',2);
INSERT INTO migrations VALUES(368,'2025_08_06_175739_create_b_o_m_s_table',2);
INSERT INTO migrations VALUES(369,'2025_08_15_210005_create_component_product_table',2);
INSERT INTO migrations VALUES(370,'2025_08_15_212046_create_proccess_products_table',2);
INSERT INTO migrations VALUES(371,'2025_08_15_213046_create_assemblies_table',2);
INSERT INTO migrations VALUES(372,'2025_08_15_213204_create_assembly_processes_table',2);
INSERT INTO migrations VALUES(373,'2025_08_23_094745_create_groups_table',2);
INSERT INTO migrations VALUES(374,'2025_08_23_094910_create_grouping_proccesses_table',2);
INSERT INTO migrations VALUES(375,'2025_08_23_095553_create_calender_days_table',2);
INSERT INTO migrations VALUES(376,'2025_08_23_095719_create_overtimes_table',2);
INSERT INTO migrations VALUES(377,'2025_08_23_095744_create_downtimes_table',2);
...
CREATE TABLE IF NOT EXISTS "products" ("id" integer primary key autoincrement not null, "code" varchar not null, "name" varchar not null, "shipping_date" datetime, "process_details" varchar, "is_completed" tinyint(1) not null default '0', "stock" integer not null default '0', "created_at" datetime, "updated_at" datetime);
...
INSERT INTO sqlite_sequence VALUES('migrations',377);
